...
| [ADR-0009](ADR-0009-model-promotion-and-budget.md) | ACCEPTED | model promotion, cost budgets and circuit breakers |
| [ADR-0010](ADR-0010-auth-backup-and-recovery.md) | ACCEPTED | local identity, remote auth, backup and recovery |
| [ADR-0011](ADR-0011-plugin-ecosystem-and-packaging.md) | ACCEPTED | plugin/tool ecosystem and packaging |
