...
- **FH-KUIKA-03.5** exact-template-bound blueprint → workflow draft + simulation preparation. — COMPLETE PRE-CUTOVER
- **FH-KUIKA-03.6** measured blueprint quality/usage telemetry. — OPEN
