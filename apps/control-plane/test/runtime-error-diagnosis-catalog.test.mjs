...
const cases = [
  ['VALIDATION_FAILURE', 'request.schema', 'VALIDATION_FAILED', 'VALIDATION', 'Input validation failed', false],
  ['CONFIGURATION_FAILURE', 'provider.config', 'CONFIGURATION_INVALID', 'CONFIGURATION', 'Configuration is invalid', false],
  ['POLICY_DENIED', 'merge-rule', 'POLICY_DENIED', 'POLICY', 'System policy denied the operation', false],
  ['SECRET_BINDING_MISSING', 'anthropic-api', 'SECRET_BINDING_MISSING', 'SECRET_BINDING', 'Required secret binding is missing', false],
  ['WORKSPACE_IDENTITY_MISMATCH', 'workspace-001', 'WORKSPACE_INVALID', 'WORKSPACE_STATE', 'Execution workspace is stale', false],
  ['REVISION_CONFLICT', 'abc123', 'REVISION_CONFLICT', 'REVISION_CONFLICT', 'Repository revision changed', false],
  ['COMMAND_FAILED', 'verify-command', 'COMMAND_FAILED', 'COMMAND_EXIT', 'Registered command failed', false],
  ['ACTIVITY_TIMEOUT', 'provider-call-001', 'ACTIVITY_TIMEOUT', 'TIMEOUT', 'Activity timed out', true],
  ['DEPENDENCY_UNAVAILABLE', 'github-api', 'DEPENDENCY_UNAVAILABLE', 'DEPENDENCY_UNAVAILABLE', 'Required dependency is unavailable', true],
  ['INTERNAL_INVARIANT', 'exact-currentness', 'INTERNAL_INVARIANT_FAILED', 'INTERNAL_INVARIANT', 'Internal invariant failed', false],
];
